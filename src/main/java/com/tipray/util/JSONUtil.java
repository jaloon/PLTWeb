...
public class JSONUtil {
	 ...
	 * @return
	 */
	public static Map<String, Object> parseJSONObjectToMap(JSONObject jsonObj) {
	...
	public static List<Map<String, Object>> parseJSONArrayToList(JSONArray jsonArr) {
	...
	public static Map<String, Object> parseJsonToMap(String jsonStr) {
		...
		return parseJSONObjectToMap(jsonObj);
	}
