...
public class EmailUtil {
     ...
     * @throws EmailException
     */
    public static void sendMultiPartEmail(String subject, String msg, String[] filePaths, String... receivers) throws EmailException {
     ...
     * @throws EmailException
     */
    public static void sendMultiPartEmail(String subject, String msg, File[] files, String... receivers) throws EmailException {
        MultiPartEmail email = new MultiPartEmail();
        init(email);
        if (files == null) {
            for (File file : files) {
