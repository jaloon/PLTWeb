...
public class ExampleAspect {
	...
	public void add(JoinPoint joinPoint) throws Throwable {
		String clazz = joinPoint.getTarget().getClass().getName();
		String methodName = joinPoint.getSignature().getName();
	...
	public void afterReturningAction(JoinPoint joinPoint, Object rtv) throws Throwable {
		String clazz = joinPoint.getTarget().getClass().getName();
		String methodName = joinPoint.getSignature().getName();
	...
	public void afterThrowingAction(JoinPoint joinPoint, Exception ex) throws Throwable {
		String clazz = joinPoint.getTarget().getClass().getName();
		String methodName = joinPoint.getSignature().getName();
