...
function SelectBox(b, c, d, e) {
    ...
    var y = (this.allowInput =
        typeof e.allowInput == "undefined" ? true : e.allowInput);
    this.fnBack = d;
    var z = this;
    this.fn = function(a) {
        z.result = a;
    ...
    b.html(
        ...
        '" placeholder="' +
        q +
        '"/>				<div class="overlay"></div>				<i><em></em></i>				<ul>				</ul>'
    );
