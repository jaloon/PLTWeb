...
public class UserTest {
	...
	public void addUser() {
		...
		try {
			/*userService.addUser(user,1l);
			userService.addUser(user1,2l);
			userService.addUser(user2,2l);
			userService.addUser(user3,2l);*/
	...
	@Test
	public void getByAccount() throws LoginException {
